...
print("✅ Data Encoded for Machine Learning")
...
# 
# # --- 5. Main App ---
# st.title("🎓 Student Performance Measure Using AI")
# st.markdown("### 🚀 Analyzing Mental Health & Performance Trends")
# st.write("")
# 
# if df is None:
#     st.error("🚨 Please upload 'Student_Mental_health.csv' to proceed!")
#     st.stop()
# 
# # --- Metrics ---
...
print("⏳ Applying Navy Blue Theme... please wait...")
time.sleep(5)
